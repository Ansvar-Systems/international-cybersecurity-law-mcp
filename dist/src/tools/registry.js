...
export function handleToolCall(db, name, args) {
    switch (name) {
        case 'search_cybersecurity_law':
            return searchCybersecurityLaw(db, args);
        case 'get_treaty_article':
            return getTreatyArticle(db, args);
        case 'get_treaty':
            return getTreaty(db, args);
        case 'list_sources':
        ...
        case 'get_national_cyber_strategy':
            return getNationalCyberStrategy(db, args);
        case 'compare_national_strategies':
            return compareNationalStrategies(db, args);
        case 'get_incident_reporting_requirements':
            return getIncidentReportingRequirements(db, args);
        case 'get_attribution_framework':
            return getAttributionFramework(db, args);
        case 'map_cyber_norms':
            return mapCyberNorms(db, args);
        case 'get_export_controls':
            return getExportControls(db, args);
